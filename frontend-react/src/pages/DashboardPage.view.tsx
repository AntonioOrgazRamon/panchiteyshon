...
export interface DashboardPageViewProps {
  ...
  leadsSinContactar: Lead[];
  upcoming: Tarea[];
  todayTasks: Tarea[];
  markingId: string | null;
  formatDate: (d: string) => string;
  formatTime: (d: string) => string;
  closingTime: (t: Tarea) => string | null | undefined;
  markAsDone: (t: Tarea) => void;
}

/** Vista del dashboard: solo presentación; recibe datos y callbacks por props. */
